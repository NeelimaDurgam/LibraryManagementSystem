...
public class SuggestedBooksTest extends LibraryManagementSystem2ApplicationTests {
	...
	@Test
	public void testaddSuggestedBookStatus() throws BookNotFoundException, ValidateSuggestedBooksException{
	...
	@Test
	public void testupdateSuggestedBookStatus() throws BookNotFoundException, ValidateSuggestedBooksException{
		Users users = new Users(18,"abc@123","Durgam","Neelima","9989151461","neelima@gmail.com","1996-5-25","2020-5-5","2020-8-5","Active");
		users= ui.register(users);
	...
	@Test
	public void testviewSuggestedBookDetails() throws BookNotFoundException, ValidateSuggestedBooksException{
